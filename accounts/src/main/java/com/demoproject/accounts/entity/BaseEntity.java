...
/*
    Note: "insertable=false and updatable=false control whether Hibernate includes a column in INSERT or
     UPDATE SQL. They are commonly used for immutable fields, audit columns, or database-managed values."
*/
}
